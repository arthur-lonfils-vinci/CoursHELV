...
public class TestLambda {
    ...
    public static void main(String[] args) {
        ...
        result = Lambda.allMatches(list, x -> x > 200);
        ...
        result = Lambda.allMatches(list, e -> e.toString().startsWith("1"));
        System.out.println(result);
...
//        //Trouve toutes les String de la liste qui commencent par "h"
        List<String> result2 = Lambda.allMatches(list2, e -> e.startsWith("h"));
